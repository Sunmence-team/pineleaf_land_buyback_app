...
export default function Index() {
  ...
  const [activeMapTab, setActiveMapTab] = useState<"all" | "myProperties" | "eligible">("all");
  ...
  return (
    <SafeAreaView className="bg-[#F4F6F1] flex-1">
      <ScrollView 
        showsVerticalScrollIndicator={false}
        contentContainerClassName="flex flex-col gap-5 px-5 pt-5 pb-5"
        refreshControl={
          <RefreshControl 
